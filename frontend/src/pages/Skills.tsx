...
// call NexusRouter endpoints. These mirror 9router's skills model: static docs
// with copyable URLs, not runtime request modifiers.
const REFERENCE_SKILLS = [
  { id: "NexusRouter", name: "NexusRouter (Entry)", endpoint: null as string | null, description: "Setup guide and index of all capabilities." },
  { id: "NexusRouter-chat", name: "Chat", endpoint: "/v1/chat/completions", description: "Chat and code generation via OpenAI or Anthropic format with streaming." },
  { id: "NexusRouter-image", name: "Image Generation", endpoint: "/v1/images/generations", description: "Text-to-image via DALL-E, Imagen, FLUX, and more." },
  { id: "NexusRouter-tts", name: "Text-to-Speech", endpoint: "/v1/audio/speech", description: "OpenAI, ElevenLabs, Edge, Google, Deepgram voices." },
  { id: "NexusRouter-stt", name: "Speech-to-Text", endpoint: "/v1/audio/transcriptions", description: "Transcribe via Whisper, Groq, Gemini, Deepgram, AssemblyAI." },
  { id: "NexusRouter-embeddings", name: "Embeddings", endpoint: "/v1/embeddings", description: "Vectors for RAG and semantic search." },
  { id: "NexusRouter-web-search", name: "Web Search", endpoint: "/v1/search", description: "Tavily, Exa, Brave, Serper, SearXNG, Google PSE, You.com." },
  { id: "NexusRouter-web-fetch", name: "Web Fetch", endpoint: "/v1/web/fetch", description: "URL to markdown/text/HTML via Firecrawl, Jina, Tavily, Exa." },
];
      ...
      <div className="space-y-6">
        <Card>
          <SectionHeader
            ...
            description="Copy a skill URL and paste it to your AI agent to teach it how to use NexusRouter endpoints."
            icon={BookOpen}
          />
...
function ReferenceSkillRow({ skill }: { skill: { id: string; name: string; endpoint: string | null; description: string } }) {
  ...
  const url = `https://raw.githubusercontent.com/ardhycrjr24/NexusRouter/main/skills/${skill.id}/SKILL.md`;
