// Package observ provides NexusRouter's native observability: Prometheus metrics
...
func New() *Metrics {
	...
	m := &Metrics{
		...
		GuardrailEval: factory.NewHistogramVec(prometheus.HistogramOpts{
			Name:    "nexusrouter_guardrail_eval_seconds",
