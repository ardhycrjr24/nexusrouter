...
// per-user accounts — matching NexusRouter's local-first, single-operator model.
...
const DefaultPassword = "nexusrouter"
...
// signing key (e.g. from NEXUSROUTER_SECURITY__JWT_SECRET).
