// Package update checks GitHub for newer NexusRouter releases and exposes the
...
const defaultRepo = "ardhycrjr24/nexusrouter"
...
func (c *Checker) fetch(ctx context.Context) (*Info, error) {
	...
	req.Header.Set("User-Agent", "nexusrouter-update-checker")
