// Package terse implements NexusRouter's output-token saving mode using the
...
// sentinel marks instruction text NexusRouter injected, so Apply is idempotent
// across retries and chained fallbacks. It is an HTML-style comment that models
// ignore in their output.
const sentinel = "<!-- nexusrouter:terse -->"
