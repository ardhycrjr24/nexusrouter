// Package app wires NexusRouter's components into a runnable application: it
...
import (
	...
	"github.com/ardhycrjr24/nexusrouter/backend/internal/auth"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/budget"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/cache"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/config"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/connectors"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/crypto"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/dispatch"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/gateway"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails/bias"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails/injection"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails/pii"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails/topics"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/guardrails/toxicity"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/healthcheck"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/httputil"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/identity"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/limits"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/meter"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/oauth"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/observ"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/pipeline"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/slimmer"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/store"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/transform"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/tunnel/cloudflare"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/tunnel/tailscale"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/update"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/usagehub"
	"github.com/ardhycrjr24/nexusrouter/backend/internal/vault"
)
...
func (a *App) Run(ctx context.Context) error {
	...
	for _, ln := range listeners {
		ln := ln
		go func() {
			a.log.Info("NexusRouter listening", "addr", ln.Addr().String(), "db", a.cfg.Database.Driver)
...
func resolveDataDir(cfg config.Config) (string, error) {
	...
	if dir == "" {
		...
		dir = filepath.Join(home, ".nexusrouter")
	}
...
// Docker image put assets under /usr/local/share/nexusrouter, while development
// builds keep them in frontend/dist.
func resolveFrontendDir() string {
	candidates := []string{
		os.Getenv("NEXUSROUTER_FRONTEND_DIR"),
		"/usr/local/share/nexusrouter/frontend/dist",
		"/usr/share/nexusrouter/frontend/dist",
		"/opt/nexusrouter/frontend/dist",
	...
	if home, err := os.UserHomeDir(); err == nil {
		candidates = append(candidates, filepath.Join(home, ".nexusrouter", "frontend", "dist"))
	}
	...
	if exe, err := os.Executable(); err == nil {
		...
		candidates = append(candidates,
			...
			filepath.Join(dir, "..", "share", "nexusrouter", "frontend", "dist"),
			filepath.Join(dir, "..", "frontend", "dist"),
		)
	}
